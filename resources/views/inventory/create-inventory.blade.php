                            ...
                            <form action="{{ route('store-inventory') }}" method="post" class="php-email-form">
                                ...
                                <div class="form-group mt-3 mb-3">
                                    ...
                                    <select class="form-control" name="kategori" id="kategori" required>
                                        ...
                                        <option value="Bunga Segar">Bunga Segar (Mawar, Lily, dll)</option>
                                        <option value="Hand Bouquet">Hand Bouquet</option>
                                        <option value="Bunga Papan">Bunga Papan Ucapan</option>
                                        <option value="Bunga Meja">Bunga Meja / Vas</option>
                                    </select>
                                </div>
                                <div class="form-group mt-3 mb-3">
