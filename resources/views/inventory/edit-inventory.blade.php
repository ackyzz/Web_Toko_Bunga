                            ...
                            <form action="{{ route('update-inventory', ['id' => $selected->id]) }}" method="post" class="php-email-form">
                                ...
                                <div class="form-group mt-3 mb-3">
                                    ...
                                    <select class="form-control" name="kategori" id="kategori" required>
                                        <option disabled selected>-- Pilih Kategori Bunga --</option>
                                        <option value="Bunga Segar" {{ $selected->kategori == "Bunga Segar" ? 'selected' : '' }}>Bunga Segar (Mawar, Lily, dll)</option>
                                        <option value="Hand Bouquet" {{ $selected->kategori == "Hand Bouquet" ? 'selected' : '' }}>Hand Bouquet</option>
                                        <option value="Bunga Papan" {{ $selected->kategori == "Bunga Papan" ? 'selected' : '' }}>Bunga Papan Ucapan</option>
                                        <option value="Bunga Meja" {{ $selected->kategori == "Bunga Meja" ? 'selected' : '' }}>Bunga Meja / Vas</option>
                                    </select>
                                </div>
                                <div class="form-group mt-3 mb-3">
